...
import { Mail, Lock, Eye, EyeOff, UserPlus, Tv, Sparkles, Shield, User, Check, AlertCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 -left-32 w-64 h-64 bg-accent-primary/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/3 -right-32 w-64 h-64 bg-accent-primary/5 rounded-full blur-3xl pointer-events-none" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-muted stroke-[1.5]" />
                <input
                  type="text"
                  required
                  value={displayName}
