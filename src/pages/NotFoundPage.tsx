        ...
        <div className="relative z-10">
          ...
          <div className="mt-12 flex justify-center">
            <svg width="120" height="80" viewBox="0 0 120 80" fill="none" className="opacity-20">
              <rect x="30" y="50" width="60" height="30" rx="8" fill="#3B82F6" />
              <circle cx="60" cy="35" r="20" fill="#3B82F6" />
              ...
              <line x1="40" y1="55" x2="40" y2="75" stroke="#3B82F6" strokeWidth="3" />
              <line x1="80" y1="55" x2="80" y2="75" stroke="#3B82F6" strokeWidth="3" />
            </svg>
          </div>
        </div>
      </div>
