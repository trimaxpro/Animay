    ...
    <PageWrapper>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-10">
        ...
        {episodes.data && episodes.data.length > 0 && (
          <section>
            <h2 className="font-display font-semibold text-xl text-text-primary mb-4">Episodes</h2>
        ...
        {anime.characters && anime.characters.length > 0 && (
          <section>
            <h2 className="font-display font-semibold text-xl text-text-primary mb-4">Characters & Voice Actors</h2>
        ...
        {recommendations.data && recommendations.data.length > 0 && (
          <section>
            <h2 className="font-display font-semibold text-xl text-text-primary mb-4">You Might Also Like</h2>
