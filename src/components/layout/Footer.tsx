    ...
    <footer className="relative mt-20 border-t border-border-subtle overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="font-display font-semibold text-sm text-text-primary">Explore</h4>
            <div className="flex flex-col gap-2">
              <Link to="/browse" className="text-text-secondary text-sm hover:text-accent-glow transition-colors">Browse</Link>
              <Link to="/schedule" className="text-text-secondary text-sm hover:text-accent-glow transition-colors">Schedule</Link>
              <Link to="/profile" className="text-text-secondary text-sm hover:text-accent-glow transition-colors">My List</Link>
            </div>
          </div>

          <div className="flex flex-col gap-3">
            <h4 className="font-display font-semibold text-sm text-text-primary">Community</h4>
